...
public class AndriodConstants {
	...
	public static class Amazon {
		...
		//public static final String first_category_expand_btn = "//android.view.View[@content-desc='Echo & Alexa']";
		public static final String first_category_expand_btn = "//android.view.View[@text='Echo & Alexa']";
		//public static final String select_product_btn = "//android.view.View[@content-desc='Amazon Echo ']";
		public static final String select_product_btn = "//*[@text='Echo Plus']";
		//public static final String select_product_btn = "//*[@class='android.view.View']";
		//public static final String add_to_cart_btn = "//android.widget.Button[contains(@content-desc,'Add to Shopping Cart')]";
		public static final String add_to_cart_btn = "//*[@text='Add to Cart']";
